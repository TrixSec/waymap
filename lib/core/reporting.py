...
"""
        ...
        <footer>
            <p><strong>Waymap v{self.config.VERSION}</strong> - Advanced Web Vulnerability Scanner</p>
            <p>© 2024-2026 Trixsec Org | Generated with ❤️ by Waymap</p>
        </footer>
    </div>
</body>
</html>
...
**Scanner**: Waymap v{self.config.VERSION}
...
**Report Generated by Waymap v{self.config.VERSION}**  
© 2024-2026 Trixsec Org
"""
        return md
